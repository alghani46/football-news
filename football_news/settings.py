...
SECRET_KEY = 'django-insecure-b%rx@r0nk-4n#mnj$max1o5yqdbal8&ltc&6bn*gc^8fitkyqb'
...
if PRODUCTION:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('muhammad.rifqi46'),
            'USER': os.getenv('muhammad.rifqi46'),
            'PASSWORD': os.getenv('NM7qyAzc'),
